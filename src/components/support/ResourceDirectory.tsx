  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <motion.div 
        ...
        className="glass p-6 rounded-2xl mb-8 space-y-6 border border-purple-100/50"
      >
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 h-12 text-lg border-purple-100 focus:border-purple-500 focus:ring-purple-500 rounded-xl"
          />
        </div>
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="h-48 bg-purple-50 rounded-2xl animate-pulse"
            />
          ))}
        </div>
